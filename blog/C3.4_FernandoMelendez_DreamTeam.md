...
Captura del circuito, donde el LED parpadea y al subir el nivel del potenciometro el tiempo del delay entre cada parpadeo aumentaba.
<p align="center">
     <img alt="esquematico" src="../img/C3.4_Circuito1.PNG" width=550 height=550>
</p>

Captura donde se baja el tiempo de delay con el potenciometro y los parpadeos eran mas rapidos.
<p align="center">
     <img alt="esquematico" src="../img/C3.4_Circuito2.PNG" width=550 height=550>
</p>
...
:cloud: [Ir a repositorio de GitHub](https://github.com/fernmelen/Sist.-Programables/blob/master/blog/C3.4_FernandoMelendez_DreamTeam.md)