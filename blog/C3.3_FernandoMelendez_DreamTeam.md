...
Captura de circuito mostrando el resultado de la salida de voltaje en la entrada analogica A0 de Arduino, cuando la fotoresistencia se encuentra en oscuridad, dejando pasar un voltaje de 0.26v.
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.3_Circuito1.PNG" width=600 height=450>
</p>

Captura de circuito mostrando el valor del voltaje al poner luz en el fotorresistor, dejando un valor de 4.76v.
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.3_Circuito2.PNG" width=600 height=450>
</p>
...
:cloud: [Ir a repositorio de GitHub](https://github.com/fernmelen/Sist.-Programables/blob/master/blog/C3.3_FernandoMelendez_DreamTeam.md)