...
![Calculos](../img/CalculosC1.4.png)
Utilizando la formula encontrada en la documentacion de la clase y despejando un poco para separar los voltajes de las resistencias pude calcular el valos de las resistencias requerido para que a partir de 2.5v de entrada, salieran 3.3v. El valor obtenido en la formula al hacer los calculos con los voltajes es de 0.32 igualado a la division de R2 entre R1; los unicos valores de resistencias comerciales que me dan esa cantidad al dividirlos es R2 = 220 ohms y R1 = 680 ohms. Este fenomeno con los voltajes se cumple por la aplicacion de amplificadores operacionales que es representado en el diagrama por IC1
___
...
:cloud: [Ir a repositorio de GitHub](https://github.com/fernmelen/Sist.-Programables/blob/master/blog/C1.4_FernandoMelendez_DreamTeam.md)
