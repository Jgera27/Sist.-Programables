...
R= El resultado observable era un led encendiendo y apagandose cada segundo, el codigo daba estas indicaciones al Arduino en el bloque loop. El codigo es entendible a simple vista, utiliza el metodo digitalwrite y recibe parametros del led; high para encender o low para apagar.

4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.

Captura de LED apagado
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.1_CircuitoLedApagado.png" width=600 height=400>
</p>
Captura de LED encendido
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.1_CircuitoLedEncendido.png" width=600 height=400>
</p>
...
:cloud: [Ir a repositorio de GitHub](https://github.com/fernmelen/Sist.-Programables/blob/master/blog/C3.1_FernandoMelendez_DreamTeam.md)